...
public class UIParticleSystem : MaskableGraphic 
{
    ...
    protected override void OnPopulateMesh(VertexHelper vh)
    {
        ...
        for (int i = 0; i < count; ++i)
        {
            ...
            Vector3 sizeScale = particle.GetCurrentSize3D(_particleSystem);
            ...
            {
                // no rotation
                Vector2 corner1 = new Vector2(position.x - sizeScale.x, position.y - sizeScale.y);
                Vector2 corner2 = new Vector2(position.x + sizeScale.x, position.y + sizeScale.y);
            ...
            {
                // apply rotation
                Vector2 right = new Vector2(Mathf.Cos(rotation), Mathf.Sin(rotation)) * sizeScale.x;
                Vector2 up = new Vector2(Mathf.Cos(rotation90), Mathf.Sin(rotation90)) * sizeScale.y;
